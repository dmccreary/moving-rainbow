...
const int NUMBER_PIXELS = 12; // Number of pixels in the LED strip
...
void loop() {
  ...
  // select the mode
   switch (mode) {
        case 0: dot(255, 0, 0);break; // red
        case 1: dot(0, 255, 0);break; // green
        case 2: dot(0, 0, 255);break; // blue
        case 3: colorWipe(255 ,0, 0);break;
        case 4: colorWipe(0, 255, 0);break;
        case 5: colorWipe(0, 0, 255);break;
        case 6: swoosh(255 ,0, 0);break;
        case 7: swoosh(0, 255, 0);break;
        case 8: swoosh(0, 0, 255);break;
