...
mode_list = ['moving rainbow', 'moving red dot', 'moving blue dot', 'moving green dot',
             ...
             'running lights', 'rainbow cycle', 'cylon scanner', 'running-lights red', 'running-lights green']
...
def swipe1(counter, color, delay):
    strip[counter] = color
    strip.write()
    sleep(delay)

def swipe_to(counter, color1, color2, delay):
    strip[counter] = color1
    strip.write()
    sleep(delay)
    strip[counter] = color2
...
while True:
    ...
    if mode == 0:
        ...
        swipe1(counter, red, .05)
    elif mode == 4:
        swipe1(counter, green, .02)
    elif mode == 5:
        ...
        bounce(counter, red, .04)
        bounce(counter, green, .02)
    elif mode == 10: 
        ...
        running_lights(counter, purple, 4, .2)
    elif mode == 14:
        swipe1(counter, white, .05)
    else:
