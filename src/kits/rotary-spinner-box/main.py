...
# Filename: main.py
#
# This is a copy of 21-demo.py saved as main.py.  The Raspberry Pi Pico runs
# main.py automatically on power-up, so the box starts the demo on its own with
# no computer attached.  To change it, edit 21-demo.py and re-upload.
#
